  ...
  return (
    <div className="container mx-auto p-8">
      ...
      <div className="flex justify-between items-center mb-4">
        ...
        />
        <Link to="/admin-dashboard/add-employee" className="bg-green-500 text-white px-4 py-2 rounded-lg">
          Add New Employee
        </Link>
      </div>
            ...
            {filteredEmployees.length > 0 ? (
              filteredEmployees.map((employee, index) => (
                <tr key={employee._id} className="text-center">
                  ...
                  <td className="py-2 px-4 border-b border-gray-200">{employee.dateOfBirth}</td>
                  ...
                  <td className="py-2 px-4 border-b border-gray-200 space-x-2">
                    ...
                    <button className="bg-yellow-500 text-white px-3 py-1 rounded">Salary</button>
                    <button className="bg-red-500 text-white px-3 py-1 rounded">Leave</button>
                  </td>
                </tr>
              ))
            ) : (
